...
import { AirtableTablesType, AirtableTablesInput } from '@graphql'
...
@Resolver()
@Auth()
export class AirtableTablesResolver {
  constructor(
  ...
  @FormGuard()
  async airtableTables(
    @Args('input') input: AirtableTablesInput
    ...
    return airtable.tables(input.baseId)
  }
}
