...
test('html to text', () => {
  expect(
    htmlToText(
      '<a href="https://github.com/heyform" title="Title">hello world</a><img src="https://github.com/heyform" alt="Logisaar Forms" />',
      0
    )
  ).toBe('hello world')
  expect(htmlToText('<a href="#">hello world<div>こんにちは世界！</div></a>')).toBe(
    'hello world こんにちは世界！'
  )
