...
export const Sidebar: FC = () => {
  ...
  if (!state.isSidebarOpen || MOTION_UNMOUNTED_STATES.includes(transitionState)) {
    return null
  }

  return (
    <div className={clsx('heyform-sidebar', `heyform-sidebar-${transitionState}`)}>
      <div className="heyform-sidebar-container">
        <div className="heyform-sidebar-heading">
          ...
          <Button.Link leading={<IconX />} onClick={handleCloseSidebar} />
        </div>
