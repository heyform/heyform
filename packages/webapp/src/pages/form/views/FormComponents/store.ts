...
import { createStoreContext } from '@heyform-inc/form-renderer'
import { createStoreReducer } from '@heyform-inc/form-renderer'
import type {
  FormField,
  FormSettings,
  FormTheme,
...
export const StoreReducer = createStoreReducer<IState>(actions, (_: any, newState: any) => newState)
