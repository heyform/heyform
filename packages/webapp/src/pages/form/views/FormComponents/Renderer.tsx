...
import {
  getTheme // getThemeStyle, insertWebFont
} from './theme'
...
export const Renderer: FC<RendererProps> = ({
  ...
  useEffect(() => {
    setAndroid(window.heyform?.device?.android || false)
  }, [])
  ...
  // // Insert theme styles
  // useEffect(() => {
  //   if (state.theme && state.theme.fontFamily) {
  //     insertWebFont(state.theme.fontFamily)
  ...
  //     style.innerHTML = getThemeStyle(state.theme, query)
  //     console.log('Applied theme styles:', state.theme)
  //   }
  // }, [state.theme, query])
  ...
  return (
    <StoreContext.Provider value={{ state, dispatch }}>
      ...
      >
        ...
        {state.settings?.enableQuestionList && state.isSidebarOpen && <Sidebar />}
      </div>
