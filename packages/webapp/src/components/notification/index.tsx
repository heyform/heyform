...
const Notification: FC<NotificationProps> = ({
  ...
  return (
    <>
      {state.status !== 'unmounted' && state.status !== 'exited' && (
        <div className={clsx('notification', `notification-transition-${state.status}`)}>
          <div className="notification-wrapper">
            ...
            <div className="notification-close">
              <Button onClick={handleClickCallback}>{CloseIcon}</Button>
            </div>
          </div>
        </div>
      )}
...
let ref: RefObject<NotificationListProps | null>
