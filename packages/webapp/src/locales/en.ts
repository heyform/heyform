export default {
  ...
  project: {
    ...
    ProjectMembers: {
      ...
      remove: 'Remove',
      assign: 'Assign',
      submissions_zero: 'submissions',
      submissions_one: 'submission',
      submissions_two: 'submissions',
      submissions_few: 'submissions',
      submissions_many: 'submissions',
  ...
  report: {
    ...
    responses_two: 'responses',
    responses_few: 'responses',
    responses_many: 'responses',
