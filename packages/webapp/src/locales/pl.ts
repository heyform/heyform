export default {
  ...
  login: {
    ...
    bindAccountDescription: 'Jesteś już użytkownikiem HeyForm? Zaloguj się i podlinkuj swoje konto.',
	...
	auth: {
		...
		resetPassword: {
			...
			sentEmail:
				'Wysłaliśmy Ci email z 6-cyfrowym kodem weryfikacyjnym, sprawdź skrzynkę na',
	...
	setup: {
		...
		explain: 'Środowisko pracy to współdzielone środowisko, w którym członkowie mogą współpracować.',
	...
	user: {
		...
		settings: {
			...
			accountText: 'Zmiany w ustawieniach konta będą obowiązywać we wszystkich Twoich środowiskach pracy.',
			password: {
	...
	report: {
		...
		noSubmission: 'Nie ma jeszcze żadnych zgłoszeń. Możesz udostępnić ten formularz większej liczbie osób.',
		average: 'średnio'
	},
	submissions: {
		Inbox: 'Odebrane',
	...
	formSettings: {
		...
		progressText: 'W łatwy sposób możesz poinformować respondentów, jak blisko są ukończenia Twojego formularza.',
		...
		redirectText:
			'Przekieruj respondentów na inną stronę po wypełnieniu Twojego formularza.',
		Update: 'Aktualizuj',
		Basic: 'Podstawowe',
		...
		submissionText:
			'Pozwala ustawić maksymalną liczbę dozwolonych zgłoszeń dla tego formularza.',
